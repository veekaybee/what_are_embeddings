...
There are numerous cases of companies training models for their own domain and their own use. For example, YouTube was one of the first companies to release a paper on embeddings used in the context of a production recommender system with "Deep Neural Networks for YouTube Recommendations."\citep{covington2016deep}. In it, they discuss the need for scale and flexibility given the large size of YouTube's user base

The second large use-case is to use embeddings as lookups. 
