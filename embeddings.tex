...
\end{minted}
\caption Word2Vec CBOW implementation in PyTorch\\ \href{https://github.com/veekaybee/viberary/blob/fix-ipynb/src/notebooks/cbow.ipynb}{ see full implementation here}
\end{figure}
