...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
	...
	\node[output neuron,pin={[pin edge={->}]right:Output Probability\\ Of hold-out word being correct}, right of=H-3] (O) {};
